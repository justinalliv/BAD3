...
urlpatterns = [
    ...
    path('om/manage-accounts/sales-representatives/<int:sales_representative_pk>/edit/', views.om_edit_sales_representative_account, name='om_edit_sales_representative_account'),
