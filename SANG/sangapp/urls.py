...
urlpatterns = [
    ...
    path('om/billing/estimated/<int:estimated_bill_id>/download/', views.om_download_estimated_bill_pdf, name='om_download_estimated_bill_pdf'),
    ...
    path('om/service-reports/<int:report_id>/download/', views.download_service_report_pdf, name='om_download_service_report_pdf'),
    ...
    path('technician/service-reports/<int:report_id>/download/', views.download_service_report_pdf, name='technician_download_service_report_pdf'),
]
